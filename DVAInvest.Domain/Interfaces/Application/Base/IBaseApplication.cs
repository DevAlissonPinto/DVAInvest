...
namespace DVAInvest.Domain.Interfaces.Application.Base;

public interface IBaseApplication<TContext, TEntity>
    ...
    where TContext : IUnitOfWork<TContext>
{
    ...
    Task<IEnumerable<TEntity>> GetAllNoTrackingAsync(Expression<Func<TEntity, bool>> predicate, params Expression<Func<TEntity, object>>[] includeProperties);
